...
import { filterData, getFilterValues } from '../utilities/data'
import noresult from '../public/house.avif'
...
const SearchFilters = () => {
    ...
    return (
        <Flex bg="gray.100" flexWrap="wrap" justifyContent="center" p="4">
            {filter.map((item) => (
                <Box key={item.queryName}>
                    <Select 
                        onChange={(e) => searchProperties({ [item.queryName]: e.target.value })}
